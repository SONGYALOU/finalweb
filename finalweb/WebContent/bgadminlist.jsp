...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="${pageContext.request.contextPath}/admin/findUserbyId">
	        	 <span>请输入要查找的用户ID：</span>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <c:forEach items="${bguser }" var="bgu">
    	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
       	 <td align="center" valign="middle" class="borderright borderbottom">${bgu.userid }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom">${bgu.userFname }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom">${bgu.userEmail }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom">${bgu.userAddress }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom">${bgu.userPhone }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom" >${bgu.userPassword }</td>
