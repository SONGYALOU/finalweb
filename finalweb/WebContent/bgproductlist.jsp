    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="${pageContext.request.contextPath}/bgproduct/findProbyId">
	        	 <span>请输入要查找的商品ID：</span>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">商品简介</th>
        <th align="center" valign="middle" class="borderright">商品数量</th>
        <th align="center" valign="middle" class="borderright">商品图片</th>
        <th align="center" valign="middle">操作</th>
      </tr>
      
      <c:forEach items="${bgprodcut }" var="bgp">
    	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
       	 <td align="center" valign="middle" class="borderright borderbottom">${bgp.productid }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom">${bgp.productname }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom">${bgp.productprice }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom">${bgp.productintroduction }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom">${bgp.prodcutnum }</td>
      	  <td align="center" valign="middle" class="borderright borderbottom" ><img src="${bgp.productimg }" width="75px" height="50px"></<img></td>
      	  <td align="center" valign="middle" class="borderbottom"><a href="${pageContext.request.contextPath}/bgproduct/findbyid?id=${bgp.productid}" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="${pageContext.request.contextPath}/bgproduct/deleteProduct?id=${bgp.productid}" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
     	 </tr>
      </c:forEach>
    </table></td>
    </tr>
